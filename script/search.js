...
{page:'home.html',name:'Home'},{page:'Interfaces.html',name:'Interfaces'},{page:'Loops.html',name:'Loops'},{page:'modules&ambients.html',name:'Modules & Ambients'},{page:'namespaces.html',name:'Namespaces'},{page:'objects.html',name:'Objects'},
